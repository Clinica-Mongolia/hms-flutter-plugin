...
class HiHealthOption {
  ...
  Map<String, dynamic> toMap() {
    return {"dataType": dataType.toMap(), "accessType": accessType.index}..removeWhere((k, v) => v == null);
  }

  @override
  bool operator ==(Object other) {
    if (!isTypeEqual(this, other)) return false;
    if (other is HiHealthOption) {
    ...
    throw Exception('== operator called on unspported type. Expecred HiHealthOption');
  }
