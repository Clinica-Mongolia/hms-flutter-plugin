...
class ScopeLangItem {
  ...
  Map<String, dynamic> toMap() {
    return {"url2Desc": url2Desc, "authTime": authTime, "appName": appName, "appIconPath": appIconPath}..removeWhere((k, v) => v == null);
  }
  ...
  bool operator ==(Object other) {
    if (isTypeEqual(this, other) && other is ScopeLangItem) {
  ...
  @override
  int get hashCode => hashValues(hashList(url2Desc?.values), authTime, appName, appIconPath);
}
