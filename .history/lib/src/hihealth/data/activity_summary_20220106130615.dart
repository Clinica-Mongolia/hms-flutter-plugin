...
class ActivitySummary {
  ...
  Map<String, dynamic> toMap() {
    return {"paceSummary": paceSummary?.toMap(), "dataSummary": dataSummary != null ? List.from(dataSummary?.map((e) => e.toMap())) : null}..removeWhere((k, v) => v == null);
  }
  ...
  factory ActivitySummary.fromMap(Map<String, dynamic> map) {
    return ActivitySummary(
        dataSummary: map['dataSummary'] != null ? List.from(map['dataSummary'].map((e) => SamplePoint.fromMap(Map<String, dynamic>.from(e)))) : null,
        paceSummary: map['paceSummary'] != null ? PaceSummary.fromMap(Map<String, dynamic>.from(map['paceSummary'])) : null);
  }

  @override
  bool operator ==(Object other) {
    if (isTypeEqual(this, other) && other is ActivitySummary) {
