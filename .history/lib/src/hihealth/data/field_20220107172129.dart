...
class Field {
  ...
  static const String NUTRIENTS_FACTS_POLYUNSATURATED_FAT = "fat.polyunsaturated";

  /// Monounsaturated fat (g).
  static const String NUTRIENTS_FACTS_MONOUNSATURATED_FAT = "fat.monounsaturated";
  ...
  /// Activity type.
  static const Field FIELD_TYPE_OF_ACTIVITY = Field.newIntField("type_of_activity");

  /// Activity type confidence.
  static const Field FIELD_POSSIBILITY_OF_ACTIVITY = Field.newFloatField("possibility_of_activity");
  ...
  static const Field FIELD_DISTANCE_DELTA = Field.newFloatField("distance_delta");
  ...
  static const Field FIELD_BASAL_METABOLISM = Field.newFloatField("basal_metabolism");
  ...
  /// Visceral fat (level).
  static const Field FIELD_VISCERAL_FAT_LEVEL = Field.newFloatField("visceral_fat_level");
  ...
  /// Skeletal muscle (kg).
  static const Field FIELD_SKELETAL_MUSCLE_MASS = Field.newFloatField("skeletal_musclel_mass");
  ...
  /// Calories (kcal).
  static const Field FIELD_CALORIES_TOTAL = Field.newFloatField("calories_total");
  ...
  /// Nutrition facts.
  static const Field FIELD_NUTRIENTS_FACTS = Field.newMapField("nutrients_facts");
  ...
  Map<String, dynamic> toMap() {
    return {"name": name, "format": format, "isOptional": isOptional}..removeWhere((k, v) => v == null);
  }

  factory Field.fromMap(Map<String, dynamic> map) {
    return Field(map['name'] != null ? map['name'] : null, map['format'] != null ? map['format'] : null, isOptional: map['isOptional'] != null ? map['isOptional'] : null);
  }
  ...
  bool operator ==(Object other) {
    if (isTypeEqual(this, other) && other is Field) {
      Field compare = other;
      List<dynamic> currentArgs = [name, format, isOptional];
      List<dynamic> otherArgs = [compare.name, compare.format, compare.isOptional];
