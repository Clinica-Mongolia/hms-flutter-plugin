...
class ActivityRecord {
  ...
  static const String ACTION_ACTIVITY_RECORD_START = "vnd.huawei.hihealth.activityRecordStart";

  /// End of an activity record.
  static const String ACTION_ACTIVITY_RECORD_END = "vnd.huawei.hihealth.activityRecordEnd";

  /// ActivityRecord object contained in additional inforation.
  static const String EXTRA_ACTIVITY_RECORD = "vnd.huawei.hihealth.activityRecord";
  ...
  ActivityRecord({this.startTime, this.endTime, this.id, this.name, this.description, this.activityTypeId, this.timeZone, this.activeTimeMillis, this.activitySummary});
  ...
  factory ActivityRecord.fromMap(Map<String, dynamic> map) {
    return ActivityRecord(
      ...
      activitySummary: map['activitySummary'] != null ? ActivitySummary.fromMap(Map<String, dynamic>.from(map['activitySummary'])) : null,
      activityTypeId: map['activityTypeId'] != null ? map['activityTypeId'] : null,
    );
  }

  @override
  bool operator ==(Object other) {
    if (isTypeEqual(this, other) && other is ActivityRecord) {
      ActivityRecord compare = other;
      List<dynamic> currentArgs = [name, description, timeZone, id, activityTypeId, startTime, endTime, activeTimeMillis, activitySummary];
      List<dynamic> otherArgs = [compare.name, compare.description, compare.timeZone, compare.id, compare.activityTypeId, compare.startTime, compare.endTime, compare.activeTimeMillis, compare.activitySummary];
  ...
  @override
  int get hashCode => hashValues(id, name, description, activityTypeId, startTime, endTime, activeTimeMillis);
}
