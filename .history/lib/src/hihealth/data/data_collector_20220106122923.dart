...
class DataCollector {
  ...
  DataCollector(
      ...
      required this.dataGenerateType,
      this.deviceId,
      this.deviceInfo,
      this.isLocalized,
      this.packageName});
  ...
  factory DataCollector.fromMap(Map<String, dynamic> map) {
    ...
    return DataCollector(
        ...
        dataStreamName:
            map['dataStreamName'] != null ? map['dataStreamName'] : null,
        deviceId: map['deviceId'] != null ? map['deviceId'] : null,
        deviceInfo: map['deviceInfo'] != null
            ? DeviceInfo.fromMap(Map<String, dynamic>.from(map['deviceInfo']))
            : null,
  ...
  @override
  int get hashCode => hashValues(name, dataGenerateType, dataStreamName,
      dataType, deviceId, deviceInfo, isLocalized, packageName);
}
