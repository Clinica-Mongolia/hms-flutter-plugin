...
class SampleSet {
  ...
  factory SampleSet.fromMap(Map<String, dynamic> map) {
    return SampleSet(map['dataCollector'] != null ? DataCollector.fromMap(Map<String, dynamic>.from(map['dataCollector'])) : null,
        map['samplePoints'] != null ? List.from(map['samplePoints'].map((e) => SamplePoint.fromMap(Map<String, dynamic>.from(e)))) : null);
  }

  Map<String, dynamic> toMap() {
    return {"dataCollector": dataCollector?.toMap(), "samplePoints": List.from(samplePoints!.map((e) => e.toMap()))}..removeWhere((k, v) => v == null);
  }
  ...
  bool operator ==(Object other) {
    if (isTypeEqual(this, other) && other is SampleSet) {
