...
class PaceSummary {
  ...
  PaceSummary({this.paceMap, this.britishPaceMap, this.partTimeMap, this.britishPartTimeMap, this.avgPace, this.bestPace, this.sportHealthPaceMap});
  ...
  factory PaceSummary.fromMap(Map<String, dynamic> map) {
    return PaceSummary(
        ...
        britishPaceMap: map['britishPaceMap'] != null ? Map<String, double>.from(map['britishPaceMap']) : null,
        britishPartTimeMap: map['britishPartTimeMap'] != null ? Map<String, double>.from(map['britishPartTimeMap']) : null,
        paceMap: map['paceMap'] != null ? Map<String, double>.from(map['paceMap']) : null,
        partTimeMap: map['partTimeMap'] != null ? Map<String, double>.from(map['partTimeMap']) : null,
        sportHealthPaceMap: map['sportHealthPaceMap'] != null ? Map<String, double>.from(map['sportHealthPaceMap']) : null);
  }
  ...
  @override
  int get hashCode =>
      hashValues(hashList(britishPaceMap?.values), hashList(britishPartTimeMap?.values), hashList(paceMap?.values), hashList(partTimeMap?.values), hashList(sportHealthPaceMap?.values), avgPace, bestPace);
}
