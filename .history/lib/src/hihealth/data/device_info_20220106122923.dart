...
class DeviceInfo {
  ...
  factory DeviceInfo.fromMap(Map<String, dynamic> map) {
    ...
    return DeviceInfo(
        ...
        fromBleDevice:
            map['fromBleDevice'] != null ? map['fromBleDevice'] : null,
        deviceManufacturer: map['deviceManufacturer'] != null
  ...
  bool operator ==(Object other) {
    ...
    DeviceInfo compare = other as DeviceInfo;
    ...
    List<dynamic> otherArgs = [
      compare.uuid,
      compare.deviceManufacturer,
      compare.modelName,
      compare.deviceType,
      compare.platformType,
      compare.fromBleDevice
    ];
    return isEquals(this, other, currentArgs, otherArgs);
  }

  @override
  int get hashCode => hashValues(uuid, deviceManufacturer, modelName,
      deviceType, platformType, fromBleDevice);
}
