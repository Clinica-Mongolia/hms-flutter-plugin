...
class SamplePoint {
  ...
  SamplePoint({this.id, this.startTime, this.endTime, this.samplingTime, this.fieldValueOptions, this.timeUnit = TimeUnit.MILLISECONDS, this.dataCollector});
  ...
  void setTimeInterval(DateTime startTime, DateTime endTime, TimeUnit timeUnit) {
  ...
  factory SamplePoint.fromMap(Map<String, dynamic> map) {
    SamplePoint instance = SamplePoint(
        ...
        samplingTime: map['samplingTime'] != null ? DateTime.fromMillisecondsSinceEpoch(map['samplingTime']) : null,
        dataCollector: map['dataCollector'] != null ? DataCollector.fromMap(Map<String, dynamic>.from(map['dataCollector'])) : null);
    if (map['insertionTime'] != null) instance._insertionTime = DateTime.fromMillisecondsSinceEpoch(map['insertionTime']);
    if (map['fieldValues'] != null) instance._fieldValues = Map<String, dynamic>.from(map['fieldValues']);
    if (map['dataTypeId'] != null) instance._dataTypeId = map['dataTypeId'];
    if (map['dataType'] != null) instance._dataType = DataType.fromMap(Map<String, dynamic>.from(map['dataType']));
    return instance;
  }
  ...
  bool operator ==(Object other) {
    if (!isTypeEqual(this, other) && other is SamplePoint) {
      SamplePoint compare = other;
      List<dynamic> currentArgs = [id, startTime, endTime, samplingTime, timeUnit, fieldValueOptions, dataCollector, _isSampling, _insertionTime, _fieldValues, _dataTypeId, _dataType];
  ...
  @override
  int get hashCode => hashValues(id, startTime, endTime, samplingTime, timeUnit, fieldValueOptions, dataCollector, _isSampling, _insertionTime, hashList(_fieldValues?.values), _dataTypeId, _dataType);
}
...
abstract class FieldValueOptions {
  ...
  @override
  bool operator ==(Object other) {
    if (isTypeEqual(this, other) && other is FieldValueOptions) {
...
class FieldMap implements FieldValueOptions {
  ...
  bool operator ==(Object other) {
    ...
    FieldValueOptions compare = other as FieldValueOptions;
    List<dynamic> currentArgs = [
      field,
      value,
    ];
